...
const About = () => {
  return (
    <div className="text-center h-full flex flex-col justify-center gap-[4rem]">
      ...
      <div>
        ...
        <div className="text-center hidden">
          ...
          specialize in creating responsive and interactive web applications. By
          merging my technical skills with creative problem-solving, I strive to
          deliver seamless user interfaces that captivate and engage. Alongside
          my frontend proficiency, I have a keen interest in game development,
          utilizing my knowledge of C# and Unity to bring virtual worlds to
          life. Continuously staying ahead in this dynamic field, I explore
          emerging technologies and techniques. When I'm not coding, you can
          find me enjoying a game of soccer or hitting the gym. Let's connect
          and collaborate on innovative projects that push the boundaries of
